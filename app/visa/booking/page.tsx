                ...
                <form className="grid lg:grid-cols-3 gap-8 items-start" onSubmit={(e: any) => {
                            ...
                            <div className="w-full space-y-6 lg:space-y-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                                    <div className="md:col-span-2 relative">
                                        <input type="text" placeholder="Full Name" name="businessName" className="w-full rounded-lg border bg-white py-3 md:py-4 px-4 text-base text-body-color placeholder:text-gray-500 outline-none focus:border-primary focus-visible:shadow-none" />
                                    </div>
                                    ...
                                    <div className="relative">
                                        <input type="date" placeholder="Passport Expiary Date" name="passportDate" className="w-full rounded-lg border bg-white py-3 md:py-4 px-4 text-base text-body-color placeholder:text-gray-500 outline-none focus:border-primary focus-visible:shadow-none" />
                                    </div>
                                    <div className="relative">
                    ...
                    <div className="bg-white rounded-xl shadow max-w-md">
                        ...
                        <div className="items-center flex flex-col gap-6 px-4 lg:px-6  py-8">
                            ...
                            <div className="w-full flex items-center">
                                <img className="w-full max-w-xs mx-auto object-contain" src="/assets/images/bkash.png" alt="payment" />
                            </div>
                        </div>
                    </div>
                </form>
